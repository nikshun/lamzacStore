...
const Relax = (props) => {
  return (
    <div className={css.Relax}>
      <div className={css.relax}>Отдыхай вместе с lamzac</div>
      <div className={css.product}>
        <div className={css.first}>
          ...
          <div className={css.text}>
            ...
            линии и окунуться в чистой воде. Единственное, что омрачает радость
            владельца матраса – необходимость каждый раз надувать его, испытывая
            прочность своих щек и легких.
          </div>
        </div>
        <div className={css.second}>
          <div className={css.relaxIn}>В парке</div>
          <img src={lamzac2} />
          <div className={css.text}>
